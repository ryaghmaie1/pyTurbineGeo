...
cq.exporters.export(TLP_Sweep1.translate((-3,0,0)),'Spar.stl')
cq.exporters.export(TLP_Sweep1.translate((-3,0,0)).section(),'Spar.dxf')
cq.exporters.export(TLP_Sweep1.translate((-3,0,0)),'Spar.step')
