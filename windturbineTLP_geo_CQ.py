...
TLP_box_x=TLP_radius1*2
TLP_box_z=TLP_radius1*2
TLP_box_y=TLP_length1
TLP_part2 = (
    cq.Workplane("XY")
    .box(TLP_box_x,TLP_box_y,TLP_box_z)
    .box(TLP_box_y,TLP_box_x,TLP_box_z)
)
#show_object(TLP_part2.translate((-3,0,-Tower_height-hub_radius-TLP_length1-0.5*TLP_box_x)))
...
cq.exporters.export(TLP_Sweep1.translate((-3,0,0)),'TLP1.stl')
cq.exporters.export(TLP_Sweep1.translate((-3,0,0)).section(),'TLP1.dxf')
cq.exporters.export(TLP_Sweep1.translate((-3,0,0)),'TLP1.step')
cq.exporters.export(TLP_part2.translate((-3,0,-Tower_height-hub_radius-TLP_length1-0.5*TLP_box_x)),'TLP2.stl')
cq.exporters.export(TLP_part2.translate((-3,0,-Tower_height-hub_radius-TLP_length1-0.5*TLP_box_x)).section(),'TLP2.dxf')
cq.exporters.export(TLP_part2.translate((-3,0,-Tower_height-hub_radius-TLP_length1-0.5*TLP_box_x)),'TLP2.step')
